...
public class RocketDTO {
	...
	public RocketDTO (String name, float currentVelocity, float currentMeters, float depositTotalFuel, List<Float> ropellantsMaximumAcceleration) throws InvalidParamException{
		this.name = name;
